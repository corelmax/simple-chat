...
export const removeRoomAccess = (roomId) => ({ type: STALK_REMOVE_ROOM_ACCESS, payload: roomId });
...
export const updateLastAccessRoom = (roomId, userId) => ({ type: UPDATE_LAST_ACCESS_ROOM, payload: ({ roomId, userId }) });
